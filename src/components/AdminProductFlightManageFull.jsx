...
import AdminProductFlightManage from './AdminProductFlightManage';

const cookie = new Cookies()
class AdminProductFlightManageFull extends Component {
    ...
    render(){
      ...
      if (newRole === 'AdminProduct') {
        return(
          ...
          <div className="tab-admin" style={{margin:"70px 0px 10px 10px", width:3100}}>
            <Nav tabs >
              <NavItem>
                <NavLink
...
export default connect(mapStateToProps)(AdminProductFlightManageFull);