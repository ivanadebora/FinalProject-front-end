            ...
            return(
                ...
                <Container style={{border: "3px solid light", backgroundColor:"#fff", width:"1200px", marginTop:-70}}>
                    ...
                    <FormGroup className="col-lg-3" style={{marginTop:30}}>
                        <img src={`http://localhost:1212${image}`} alt={nama} width='150px'/>
                        <h3 style={{fontSize:"20px", color:"#000", fontWeight:"bold"}}>{nama}</h3>
                        <h3 style={{fontSize:"18px", color:"#000"}}>{code}</h3>
                        <h3 style={{fontSize:"15px", color:"#000"}}>Kelas {seat_class}</h3>
                    </FormGroup>
                    <FormGroup className="col-lg-3" style={{marginTop:30}}>
                    ...
                    <FormGroup className="col-lg-3" style={{marginTop:30}}>
                        <h3 style={{fontSize:"16px", color:"#000", textAlign:"left", fontWeight:'bold'}}>{departure_city}</h3>
                        <h3 style={{fontSize:"15px", color:"#000", textAlign:"left"}}>{departure_airport} ({departure_terminal})</h3>
                        <br/>
                        <h3 style={{fontSize:"16px", color:"#000", textAlign:"left", fontWeight:'bold'}}>to:</h3>
                        <br/>
                        <h3 style={{fontSize:"16px", color:"#000", textAlign:"left", fontWeight:'bold'}}>{arrival_city}</h3>
                        <h3 style={{fontSize:"15px", color:"#000", textAlign:"left"}}>{arrival_airport} ({arrival_terminal})</h3>
                    </FormGroup>
                    <FormGroup className="col-lg-3" style={{marginTop:30}}>
