...
import AdminPaymentFlightManage from './AdminPaymentFlightManage';

const cookie = new Cookies()
class AdminPaymentFlightManageFull extends Component {
    ...
    render(){
      ...
      if (newRole === 'AdminPembayaran') {
        return(
          ...
          <div className="tab-admin" style={{margin:"70px 0px 10px 10px", width:2500}}>
            <Nav tabs >
              <NavItem>
                <NavLink
...
export default connect(mapStateToProps)(AdminPaymentFlightManageFull);